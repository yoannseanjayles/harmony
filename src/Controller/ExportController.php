...
/**
 * T255 / HRM-T267 â€” ExportController: HTML and PDF export endpoints.
 *
 * Routes:
 *   GET /export/{id}/html â€” self-contained HTML download (T255)
 *   GET /export/{id}/pdf  â€” PDF via Gotenberg with HTML fallback (HRM-T267/T268/T269)
 */
#[Route('/export')]
final class ExportController extends AbstractController
{
    /**
     * T255 â€” Download a self-contained HTML export of a project.
     */
    ...
    /**
     * HRM-T267/T268/T269 â€” Export a project as PDF via Gotenberg.
     *
     * On Gotenberg failure (HRM-T268):
     *   - Logs the failure with structured context (HRM-T272)
     *   - Returns HTTP 503 JSON with errorCode, message and htmlFallbackUrl (HRM-T269)
     */
    ...
    public function exportPdf(
        ...
        try {
            ...
            // HRM-T272 â€” log the failure with structured reason
            ...
            // HRM-T268 / T269 â€” structured failure response with HTML fallback URL
