    ...
    public function promptInstructions(): string
    {
        return implode("\n", [
            ...
            '- notes: up to 400 characters',
             ...
             'For type "split": {"title":"...","body":"text content","subtitle":"optional","layout":"text-left"} — layout can be "text-left" (default) or "text-right"; image placeholder on the other side.',
